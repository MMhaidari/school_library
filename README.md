...
**school library** is a program which  record what books are in the library and who borrows them.
...
```sh
  cd my-folder
  git clone https://github.com/MMhaidari/school_library.git
```
...
> I would like to thank Microverse for providing the basic planing for the project
